...
<html lang="en">
  ...
  <head>
    ...
    <link rel="preload" href="{{url('assets/dist/css/adminlte.css')}}" as="style" />
  ...
  <body class="layout-fixed sidebar-expand-lg sidebar-open bg-body-tertiary">
    ...
    <div class="app-wrapper">
      ...
      <footer class="app-footer">
        <!--begin::To the end-->
        <div class="float-end d-none d-sm-inline">Versint 1.0</div>
        <!--end::To the end-->
        <!--begin::Copyright-->
        All rights reserved.
        <strong>
          Copyright &copy; 2014-2025&nbsp;
          <a href="https://adminlte.io" class="text-decoration-none">By Kol Sokea</a>.
        </strong>
