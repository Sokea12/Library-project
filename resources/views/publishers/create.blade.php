...
@section('content-header')
     <!--begin::Row-->
     <div class="row">
       <div class="col-sm-6"><h3 class="mb-0">Create New publishers</h3></div>
       <div class="col-sm-6">
    ...
    <div class="row justify-content-center"> <!-- Added justify-content-center here -->
        ...
        <div class="card card-primary card-outline mb-4">
            ...
            <div class="card-header">
                <div class="card-title">Create New publishers</div> <!-- Changed title -->
            </div>
            <!--end::Header-->
            <!--begin::Form-->
            <form action="{{ route('publishers.store') }}" method="POST"> <!-- Added form action -->
                @csrf
                <!--begin::Body-->
                <div class="card-body">
                    <div class="mb-3">
